...
# Page configuration
st.set_page_config(
    page_title="Chat with Fiyarlin K",
    page_icon="🤖",
    layout="centered",
...
def ask_chatbot(query, chat_history=None):
    ...
    # Build system prompt
    system_prompt = (
        f"You are Fiyarlin K's personal AI assistant. "
        f"Your job is to help users learn about Fiyarlin K's background, "
        ...
        f"Use the provided excerpts as your primary source of truth for factual information about Fiyarlin K. "
        ...
        f"Answer in third person when talking about Fiyarlin K, but you may use natural conversational language "
